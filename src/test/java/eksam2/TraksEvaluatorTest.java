...
public class TraksEvaluatorTest {
    ...
    public void test07_default() {
        fail("See test avalikustatakse pärast eksamit! Kas ülesande kirjelduse seitsmenda punktini jõudsid!?");
    }

    @Test
    public void test08_multiple() {
        fail("See test avalikustatakse pärast eksamit! Lihtsalt keerulisemad laused.");
    }
